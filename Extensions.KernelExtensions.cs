...
namespace dewitcher.Extensions
{
    ...
    public static class KernelExtensions
    {
        ...
        public static void ShowBootscreen(this Cosmos.System.Kernel krnl, string OSname, Visual.Bootscreen.Effect efx,
            ConsoleColor color, int ticks = 10000000) { Visual.Bootscreen.Show(OSname, efx, color, ticks); }
    }
}
